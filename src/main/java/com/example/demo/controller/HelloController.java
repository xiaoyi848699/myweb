...
//		log.println("Login.success"+username+password);
//		return "homepage.html";
//	}
//	@RequestMapping("/register")
//	private String register(String username,String recommendation,String phone,String email,String password){
//		log.println("register.success"+username+","+recommendation+","+email+","+password+","+phone);
//		return "index.html";
//	}
